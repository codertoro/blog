...
4. 登录到域名注册商提供的域名解析页面进行添加相应信息即可，其中`www.codertoro.com`需要添加子域名，即二级域名([如何添加二级域名?](https://help.aliyun.com/document_detail/29719.html?spm=a2c1d.8251892.help.ddoc.4a055b767JrkOW))。
